...
void CEcoLab1Sink_printBeforeIntArray(const void *array, size_t n) {
    ...
    SetConsoleTextAttribute(handle, FOREGROUND_GREEN | FOREGROUND_INTENSITY | BACKGROUND_RED | FOREGROUND_BLUE);
    for (i = 0; i < n; ++i) {
        printf("%d ", arr[i]);
    }
...
void CEcoLab1Sink_printIntBucketSortStep(const void *bucket, size_t bucket_size) {
    int16_t* arr = (int16_t*)bucket;
    size_t i;
...
void CEcoLab1Sink_printAfterIntArray(const void *array, size_t n) {
    ...
    HANDLE handle = GetStdHandle(STD_OUTPUT_HANDLE);
    SetConsoleTextAttribute(handle, FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE | BACKGROUND_GREEN);
    for (i = 0; i < n; ++i) {
        printf("%d ", arr[i]);
    }
    SetConsoleTextAttribute(handle, FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE);
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnBeforeBucketSort(/* in */ struct IEcoLab1Events* me, /* in */ const void *array, size_t count) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
...
int16_t ECOCALLMETHOD CEcoLab1Sink_BucketSortStep(struct IEcoLab1Events* me, const void *bucket, size_t bucket_size, int16_t bucket_index) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
	...
	CEcoLab1Sink_printIntBucketSortStep(bucket, bucket_size);
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnAfterBucketSort(struct IEcoLab1Events* me, const void *array, size_t count) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
